  ...
  return (
    <div className="mb-4">
      ...
      <input
        ...
        className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 fouc:ring-blue-500 ${className}`}
      />
    </div>
  );
});
...
const RefProps = () => {
  ...
  return (
    <section className="p-8 bg-white rounded-xl shadow-lg mt-5">
      ...
      <div className="space-y-6">
        <div className="bg-blue-50 p-6 rounded-lg">
          ...
          <CustomInput
            ...
            placeholder="First input with ref ..."
          />

          <CustomInput
            ref={secondInputRef}
            label="Second Input (with ref)"
            placeholder="Second input with ref ..."
          />
